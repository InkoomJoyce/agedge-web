    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-amber-600 rounded-full blur-3xl animate-pulse [animation-delay:1000ms]" />
        </div>

        {/* Fixed: Grid Pattern using inline style instead of Tailwind arbitrary value */}
        <div
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className={`space-y-8 transition-all duration-1000 transform ${
              ...
              <div className="inline-flex items-center gap-3">
                ...
                <span className="text-amber-400 text-sm font-mono tracking-wider uppercase">
                  Since 2016
                </span>
              </div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed border-l-2 border-amber-500/50 pl-6">
                From luxury estates in East Legon to industrial warehouses in Tema,
                <span className="text-amber-300 font-semibold"> AGEdge Global</span> brings vision, materials,
              ...
              {/* <div className="grid grid-cols-2 gap-6 pt-4">
                {stats.map((stat, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="relative bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10 hover:border-amber-500/30 transition-all duration-500 group-hover:transform group-hover:-translate-y-1">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link
                  to="/about"
                  className="group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-full font-semibold overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-amber-500/25 hover:scale-105"
                >
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-full font-semibold hover:bg-white/20 transition-all duration-300 hover:scale-105"
                >
                  Start a Project
                </Link>
              </div>
            ...
            <div className={`relative transition-all duration-1000 delay-300 transform ${
              ...
              <div className="relative group">
                <div className="absolute -inset-4 bg-gradient-to-r from-amber-500/20 to-transparent rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <img
                    ...
                    className="w-full h- lg:h- object-cover transform group-hover:scale-110 transition-transform duration-700"
                    loading="lazy"
                  />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 z-20 bg-gradient-to-t from-black/80 to-transparent">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <p className="text-amber-400 text-sm font-mono tracking-wider">Featured Project</p>
                    </div>
                ...
                <div className="absolute -top-4 -right-4 bg-gradient-to-r from-amber-500 to-amber-600 rounded-full p-4 shadow-xl animate-bounce">
                ...
                <div className="absolute -bottom-6 -left-6 w-32 h-32 border-2 border-amber-500/20 rounded-full" />
                <div className="absolute -top-6 -right-6 w-24 h-24 border border-amber-500/10 rounded-full" />
              </div>

              <div className="flex flex-wrap gap-3 mt-6 justify-center lg:justify-start">
                <div className="px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full text-xs text-gray-300 border border-white/10">
