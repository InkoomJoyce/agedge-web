...
const SERVICE_CATEGORIES = [
  ...
  { id: "design", label: "Design & Costing" },
  { id: "construction", label: "Construction" },
  { id: "supervision", label: "Supervision" },
  { id: "advisory", label: "Advisory" },
  { id: "renovation", label: "Renovations" },
  { id: "procurement", label: "Procurement" },
  { id: "facility", label: "Facility Mgmt" },
];
...
export default function Services() {
  ...
  // Service data — 8 services, ONLY Feasibility has a link
    ...
    () => [
      {
        ...
        description:
          "Comprehensive project analysis to ensure success before you build — validating viability, cost, and risk.",
        slug: "feasibility",
        ...
        image: "/images/projects/faith-montessori-admin-block/1.png",
      },
      {
        id: 2,
        category: "design",
        ...
        description:
          "Innovative, climate-smart designs paired with accurate cost estimation from concept to construction drawings.",
        slug: "design-costing",
        link: null,
        features: [
        ...
        image: "/images/projects/kantu-residence/1.jpeg",
      },
      {
        id: 3,
        ...
        title: "Construction",
        description:
          "Full-scale construction management and execution — from foundation to finishing with quality assurance.",
        slug: "construction",
        link: null,
        features: [
        ...
        image: "/images/projects/richmond-complex/1.jpeg",
      },
      {
        id: 4,
        ...
        description:
          "Dedicated oversight across the entire project lifecycle — keeping schedules, budgets, and quality on track.",
        ...
        image: "/images/projects/tachie-enclave/1.jpeg",
      },
      {
        id: 5,
        category: "advisory",
        ...
        description:
          "Strategic guidance for developers and investors — from site selection to project delivery strategy.",
        slug: "advisory-consulting",
        link: null,
        features: [
          "Site Selection & Land Studies",
          "Development Strategy",
          "Investment Advisory",
          "Regulatory Guidance",
          "Project Structuring",
        ],
        image: "/images/projects/the-francis/1.jpeg",
      },
      {
        id: 6,
        category: "renovation",
        icon: Wrench,
        title: "Facelifts & Renovations",
        description:
          "Transform existing spaces with modern upgrades, refreshed interiors, and smarter layouts.",
        slug: "facelifts-renovations",
        link: null,
        features: [
        ...
        image: "/images/projects/nanas-residence/1.jpeg",
      },
      {
        id: 7,
        ...
        title: "Procurement",
        description:
          "Global sourcing and reliable delivery of premium building materials, equipment, and finishes.",
        slug: "procurement",
        link: null,
        features: [
      ...
      },
      {
        ...
        description:
          "Ongoing maintenance, operations, and lifecycle care that protects your investment long after handover.",
        ...
        image: "/images/projects/abenas-home/1.jpeg",
      },
    ],
    []
  );

  // Additional services — only Feasibility has a link
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`text-center mb-12 ${getAnimationClasses(0)}`}>
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto font-light">
              Feasibility • Design & Costing • Construction • Supervision • Advisory • Renovations • Procurement • Facility Management
            </p>

            <p className="text-gray-700 max-w-3xl mx-auto mt-4 text-sm sm:text-base leading-relaxed">
              A vertically integrated powerhouse bringing feasibility studies,
              design, construction, supervision, advisory, renovation,
              procurement, and facility management under one roof. We remove
              middleman friction and deliver turnkey solutions with
          ...
          <div className={`grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 ${getAnimationClasses(100)}`}>
            {QUALITY_METRICS.map((metric, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="text-center p-4 bg-white rounded-xl border border-gray-200/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                >
          ...
          {/* Core Services Grid — 4 columns on large screens */}
          <div className={`grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 ${getAnimationClasses(200)}`}>
            {filteredServices.map((service) => {
              ...
              return (
                <div
                  ...
                  className={`group bg-white rounded-xl border border-gray-200/50 overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 flex flex-col ${
                ...
                >
                  <div className="relative h-40 overflow-hidden">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 flex items-start justify-between gap-2">
                      <div className="inline-flex p-1.5 bg-white/25 backdrop-blur-md rounded-lg border border-white/30">
                        <Icon className="w-5 h-5 text-white" />
                      </div>
                      {isClickable && (
                        <div className="px-2 py-0.5 bg-green-500/90 text-white text-[10px] font-medium rounded-full backdrop-blur-sm">
                          Learn More
                        </div>
                      )}
                    </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              {GLOBAL_PARTNERS.map((partner, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="text-center p-3 bg-white rounded-xl border border-gray-200/50 hover:shadow-md transition-all duration-300 hover:-translate-y-1"
                  >
            ...
            <div className="grid grid-cols-2 gap-3">
              {INNOVATION_HIGHLIGHTS.map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-4 bg-white rounded-xl border border-gray-200/50 text-center hover:border-green-200 hover:shadow-md transition-all duration-300"
                  >
          ...
          {/* CTA Section */}
          <div
            className={`text-center py-10 px-6 bg-gradient-to-r from-gray-50 to-green-50 rounded-2xl border border-green-100/50 ${getAnimationClasses(450)}`}
          >
            <h3 className="text-xl font-bold text-gray-900 mb-2">Ready to Build Your Vision?</h3>
            <p className="text-sm text-gray-600 mb-5">
              Let's discuss how our integrated services can bring your project to life
            </p>
